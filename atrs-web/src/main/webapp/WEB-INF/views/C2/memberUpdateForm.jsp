...
<html lang="ja">
  <head>
    ...
    <title>会員情報変更 | Airline Ticket Reservation System</title>
  ...
  <body>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form:form id="membership-form" cssClass="form-horizontal"
                ...
                <div class="form-group">
                  <form:label path="currentPassword" cssClass="col-md-4 control-label">現在のパスワード</form:label>
                  <div class="col-md-8">
                    <form:password path="currentPassword" cssClass="form-control" maxlength="20"
                      data-parsley-length="[8, 20]"/>
                    <form:errors path="currentPassword" cssClass="invalid" element="span"/>
                  </div>
                </div>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/member-update-form.js"></script>
  </body>
</html>
