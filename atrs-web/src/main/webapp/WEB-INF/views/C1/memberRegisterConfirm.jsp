                        ...
                        <div class="panel-body">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="kanjiName" class="form-control-static">${f:h(memberRegisterForm.kanjiFamilyName)}&nbsp;${f:h(memberRegisterForm.kanjiGivenName)}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="kanaName" class="form-control-static">${f:h(memberRegisterForm.kanaFamilyName)}&nbsp;${f:h(memberRegisterForm.kanaGivenName)}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="gender" class="form-control-static">${f:h(CL_GENDER[memberRegisterForm.gender.code])}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="tel" class="form-control-static">${f:h(memberRegisterForm.tel1)}-${f:h(memberRegisterForm.tel2)}-${f:h(memberRegisterForm.tel3)}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="zipCode" class="form-control-static">&#12306;${f:h(memberRegisterForm.zipCode1)}-${f:h(memberRegisterForm.zipCode2)}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="address" class="form-control-static">${f:h(memberRegisterForm.address)}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="mail" class="form-control-static">${f:h(memberRegisterForm.mail)}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="creditType" class="form-control-static">${f:h(CL_CREDITTYPE[memberRegisterForm.creditTypeCd])}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="creditNo" class="form-control-static">${f:cut(memberRegisterForm.creditNo, 4)}************</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <p id="credit-expiration-date" class="form-control-static">${f:h(memberRegisterForm.creditMonth)}/${f:h(memberRegisterForm.creditYear)}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <form:form cssClass="col-md-offset-4 col-md-8" action="${pageContext.request.contextPath}/member/register" method="post" modelAttribute="memberRegisterForm">
