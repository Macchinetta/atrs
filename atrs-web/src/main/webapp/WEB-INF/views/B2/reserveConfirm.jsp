        ...
        <div class="container">
            <div class="row">
                <section class="col-md-12">
                    ...
                    <section>
                        <h3>合計金額</h3>
                        <p id="total-amount">&yen;<fmt:formatNumber value="${reserveConfirmOutputDto.totalFare}" pattern="###,###" /></p>
                    </section>
                    ...
                    <section class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <p id="representative-telephone-number" class="form-control-static">
                                    ${f:h(ticketReserveForm.repTel1)}-${f:h(ticketReserveForm.repTel2)}-${f:h(ticketReserveForm.repTel3)}
                                </p>
                            </div>
                        </div>
                    ...
                    <form:form cssClass="text-center btns-block" method="post" action="${pageContext.request.contextPath }/ticket/reserve" modelAttribute="ticketReserveForm">
                        <%-- 選択フライト情報 --%>
